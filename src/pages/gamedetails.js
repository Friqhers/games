...
class GameDetails extends Component {
    ...
    async componentDidMount() {
        ...
        const data = await API.graphql(graphqlOperation(listGames, { filter: { id: { contains: `${this.props.match.params.id}` } } }))
        if (data != null) {
            this.setState({
                                ...
                                <div key={result.id}>
                                    <div className="container-fluid text-center">
                                        ...
                                        <div className="row content row_">
                                            ...
                                            <div className="col-lg-4 text-center details_left" id="center_text">
                                                <br></br><img src={result.thumbnail_img}></img>
                                            </div>
                                            {/*COLUMN 1 END*/}

                                            {/*COLUMN 2 START*/}
                                            <div className="col-lg-8" id="center_text">
                                                <h1 className="text-center title_details">{result.name}</h1>
                                        ...
                                        <div className="row content row_">
                                            ...
                                            {/*COLUMN 1 START*/}
                                            <div className="col-lg-4 text-left details_left" id="center_text">
                                                <br></br>
